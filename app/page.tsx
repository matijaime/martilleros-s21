...
import {
  ...
  Images, ChevronLeft, Music, FileCheck2, ArrowRight,
} from 'lucide-react';
            ...
            >
              ...
              <div className="flex border-b border-white/5">
                ...
                >
                  ...
                  Recursos
                  {(subjectResources.length > 0 || selectedSubject.title === 'DERECHO PRIVADO CIVIL') && (
                    <span className="ml-1 text-xs px-1.5 py-0.5 rounded-full bg-gold/10 text-gold">
                      {subjectResources.length + (selectedSubject.title === 'DERECHO PRIVADO CIVIL' ? 1 : 0)}
                    </span>
                  )}
                </button>
                <button
              ...
              <div className="p-6 sm:p-8 space-y-6">
                ...
                {modalTab === 'recursos' && (
                  (subjectResources.length === 0 && selectedSubject.title !== 'DERECHO PRIVADO CIVIL') ? (
                    ...
                    <>
                      {selectedSubject.title === 'DERECHO PRIVADO CIVIL' && (
                        <div className="mb-6">
          ...
          <div className="glass rounded-3xl border border-white/5 overflow-hidden">
            ...
            <div className="p-8 sm:p-10 space-y-6">
              ...
              <div className="flex gap-5 items-start">
                ...
                <div className="flex-1">
                  <h3 className="text-white font-semibold text-sm mb-1.5">Descargá tu Certificado de Alumno Regular</h3>
                  <p className="text-slate-400 text-sm leading-relaxed mb-4">
                    Ingresá al portal de estudiantes de la Siglo 21, dirigite a la sección de certificados y descargá el <strong className="text-white">Certificado de Alumno Regular</strong> en formato PDF.
                  </p>
                  <a
                    href="https://estudiantes.uesiglo21.edu.ar/es-AR/certificados"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center gap-2 bg-gold/10 hover:bg-gold/20 text-gold text-xs font-semibold px-5 py-2.5 rounded-xl transition-all border border-gold/20 hover:border-gold/40"
                  >
              ...
              {/* Divider sutil */}
              <div className="border-t border-white/5 ml-14" />

              {/* Paso 2 */}
              <div className="flex gap-5 items-start">
                <div className="flex-shrink-0 w-10 h-10 rounded-full bg-[#1DB954]/10 border border-[#1DB954]/30 flex items-center justify-center">
                  <span className="text-[#1DB954] font-bold text-sm">2</span>
                </div>
                <div className="flex-1">
                  <h3 className="text-white font-semibold text-sm mb-1.5">Verificá tu cuenta en Spotify</h3>
                  <p className="text-slate-400 text-sm leading-relaxed mb-4">
                    Entrá a la página de Spotify para Estudiantes, iniciá sesión con tu cuenta y subí el PDF del certificado que descargaste en el paso anterior. Spotify verificará tu condición de alumno y activará el beneficio.
                  </p>
                  <a
                    href="https://www.spotify.com/ar/student/"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center gap-2 bg-[#1DB954]/10 hover:bg-[#1DB954]/20 text-[#1DB954] text-xs font-semibold px-5 py-2.5 rounded-xl transition-all border border-[#1DB954]/20 hover:border-[#1DB954]/40"
                  >
